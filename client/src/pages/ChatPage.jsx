...
export const ChatPage = () => (
  <div className="min-h-screen bg-slate-50 flex items-center justify-center p-8">
    <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm text-center max-w-md">
      ...
      <h1 className="text-2xl font-bold text-slate-800 mt-4">AI Clause Chat</h1>
      <p className="text-slate-500 text-sm mt-2">Ask questions about your contracts directly. Feature coming soon!</p>
